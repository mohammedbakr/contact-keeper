  ...
  return (
    <div className="card bg-light">
      <h3 className="text-primary text-left">
        {/* capitalize the first letter: 1-CSS or 2-JS */}
        {/* {name}{' '}<span style={{float: 'right'}} className={`badge ${type === 'professional' ? 'badge-success' : 'badge-primary'}`} style={{textTransform: 'capitalize'}}>{type}</span> */}
